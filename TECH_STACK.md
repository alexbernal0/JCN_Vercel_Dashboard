...
| **Charts/Tables**    | Tremor                      | 3.x                        | Cards, portfolio tables                   |
| **Screener Table**   | TanStack Table              | v8 (@tanstack/react-table) | Sortable, filterable screener results     |
| **Charts**           | TradingView Widgets         | Embedded                   | Heatmap, candle charts, company profile   |
| **Charts**           | ECharts + echarts-for-react | 5.x / 3.x                  | Line charts (normalized price comparison) |
...
next, react, tremor, @tremor/react, @tanstack/react-table, echarts, echarts-for-react, swr, tailwindcss.
